...
class GeoState < ActiveRecord::Base
  ...
  delegate :online_reg_url, :redirect_to_online_reg_url, :async_submit_to_online_reg_url, :can_submit_to_online_reg_url, :has_ovr_pre_check?, :ovr_pre_check, :decorate_registrant, :enabled_for_language?, :require_age_confirmation?, :require_id?, :automatic_under_18_ok?, :custom_step_2?, :to=>:state_customization
